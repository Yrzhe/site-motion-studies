...
This folder contains public media for understanding the study without
redistributing the original Oryzo site.

## Original Reference

`original-reference/oryzo-hero-reference.jpg` is a low-resolution reference still
used to discuss the composition: brand mark, left text rail, central product
scene, and technical measurement overlay. It is not an asset source for demos.
